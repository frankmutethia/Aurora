    ...
    <footer className="border-t border-sky-100 bg-white">
      <div className="container mx-auto px-4 py-8 grid gap-6 md:grid-cols-3">
        <div className="space-y-2">
          <h4 className="font-semibold">Smart Rentals Pty Ltd</h4>
          <p className="text-sm text-muted-foreground">Unit 2/11 Burrows Avenue, Dandenong VIC 3175</p>
          <p className="text-sm text-muted-foreground">Phone: 0420 759 910 / 0416 003 905</p>
          <p className="text-sm">Email: <a href="mailto:smartrentals58@gmail.com" className="underline hover:text-sky-700">smartrentals58@gmail.com</a></p>
        </div>
        <div className="space-y-2">
      ...
      <div className="text-center text-xs text-muted-foreground pb-6">© {new Date().getFullYear()} Smart Rentals Pty Ltd. All rights reserved.</div>
    </footer>
  )
}
